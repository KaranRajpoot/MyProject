...
// MyProject
#define COCOAPODS_POD_AVAILABLE_MyProject
#define COCOAPODS_VERSION_MAJOR_MyProject 1
#define COCOAPODS_VERSION_MINOR_MyProject 0
#define COCOAPODS_VERSION_PATCH_MyProject 0
